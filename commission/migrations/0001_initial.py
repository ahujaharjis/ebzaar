    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_gateway_pass', models.BooleanField(default=False)),
                ('tax_inclusive', models.BooleanField(default=False)),
                ('store_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcStorelocatorStore')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('FLAT PER ORDER', 'FLAT PER ORDER'), ('FLAT PER SKU', 'FLAT PER SKU'), ('PERCENTAGE', 'PERCENTAGE'), ('RATE PER CATEGORY', 'RATE PER CATEGORY')], max_length=100)),
                ('rate', models.DecimalField(decimal_places=2, max_digits=10)),
                ('date_from', models.DateField()),
                ('date_to', models.DateField(blank=True, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcCategory')),
                ('sku', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcProduct')),
                ('store_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcStorelocatorStore')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('Cancelled By Store', 'Cancelled By Store'), ('Customer Not Available', 'Customer Not Available')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_from', models.DateField()),
                ('date_to', models.DateField(blank=True, null=True)),
                ('sku', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcProduct')),
                ('store_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='commission.OcStorelocatorStore')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='commission.OcCustomerpartnerToCustomer')),
